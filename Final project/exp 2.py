...
retry_button = tk.Button(hangman_frame, text="Retry", font=("Arial", 14), command=retry_game)

# Button to quit game
quit_button = tk.Button(hangman_frame, text="Quit", font=("Arial", 14), command=quit_game)
